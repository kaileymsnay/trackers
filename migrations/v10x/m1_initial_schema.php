...
namespace kaileymsnay\trackers\migrations\v10x;
			...
			'add_tables'		=> [
				...
				$this->table_prefix . 'trackers_projects'			=> [
					'COLUMNS'		=> [
						...
						'project_visibility'	=> ['TINT:3', 0],
						'project_status'		=> ['TINT:3', 0],
					],
				...
				$this->table_prefix . 'trackers_tickets'			=> [
					'COLUMNS'		=> [
						...
						'ticket_title'			=> ['VCHAR:255', ''],
						'ticket_poster'			=> ['UINT', 0],
						'ticket_time'			=> ['TIMESTAMP', 0],
						'ticket_status'			=> ['TINT:3', 0],
						'ticket_first_post_id'	=> ['UINT', 0],
						'ticket_visibility'		=> ['TINT:3', 0],
						'status_id'				=> ['UINT', 0],
						'component_id'			=> ['UINT', 0],
						'severity_id'			=> ['UINT', 0],
						'duplicate_id'			=> ['UINT', 0],
					...
					'KEYS'			=> [
						...
						'project_id'			=> ['INDEX', ['project_id']],
						'ticket_poster'			=> ['INDEX', ['ticket_poster']],
